...
function calculateROI() { 
    ...
    document.getElementById("potentialCO2EmissionSavings").innerHTML="<ul><li>This also amounts to carbon emission savings between <strong>" + co2Savings1.toLocaleString() + " metric tons of CO2</strong> per year and <strong>" + co2Savings2.toLocaleString() + " metric tons of CO2 per year</strong>.</li></ul>";
    document.getElementById("feasibilityStudyInvestment").innerHTML="<ul><li>We can conduct a feasibility study to analyze and evaluate the potential savings at  <strong>" + feasibilityStudyPrice.toLocaleString() + " USD</strong> to achieve these savings.</li></ul>";
    document.getElementById("implementationInvestment").innerHTML="<ul><li>A further implementation project investment of <strong>" + implementationProject.toLocaleString() + "* USD</strong> is needed after we concluded a potential savings is feasible.</li></ul>";
